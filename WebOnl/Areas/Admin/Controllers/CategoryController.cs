...
namespace WebOnl.Areas.Admin.Controllers
{
    public class CategoryController : Controller
    {
        ...
        {
            var categories = db.Categories.ToList(); // Lấy danh sách danh mục từ cơ sở dữ liệu và chuyển nó thành danh sách List.
            return View(categories); // Truyền danh sách danh mục sang View.
        }
